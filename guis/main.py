...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnBuildDFG.setGeometry(QtCore.QRect(320, 220, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.linePathForLlvm.setGeometry(QtCore.QRect(20, 170, 651, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btnChooseLlvm.setGeometry(QtCore.QRect(690, 170, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 140, 181, 16))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.linePathForC_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.linePathForC_2.setGeometry(QtCore.QRect(820, 40, 441, 211))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.linePathForC_2.setFont(font)
        self.linePathForC_2.setReadOnly(True)
        self.linePathForC_2.setObjectName("linePathForC_2")
